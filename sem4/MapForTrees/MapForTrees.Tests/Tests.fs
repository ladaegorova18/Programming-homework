...
let testCases =
    [
        (fun x -> x + 1), Node(5, Node(3, Tree.Empty, Tree.Empty), Tree.Empty), Node(6, Node(4, Tree.Empty, Tree.Empty), Tree.Empty)
        (fun x -> x * 3), Tree.Empty, Tree.Empty
        (fun x -> x * 0), Node(400, Node(-400, Tree.Empty, Tree.Empty), Node(9, Tree.Empty, Tree.Empty)), Node(0, Node(0, Tree.Empty, Tree.Empty), Node(0, Tree.Empty, Tree.Empty))
